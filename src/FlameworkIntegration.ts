 ...
 */
export const Controller = Modding.createDecorator<[ControllerConfig]>("Class", (descriptor, [config]) => {
...
export function LoadModules(parent: Instance): void{
	const modules = [parent, ...parent.GetDescendants()].filter((descendant) => descendant.IsA("ModuleScript"));
